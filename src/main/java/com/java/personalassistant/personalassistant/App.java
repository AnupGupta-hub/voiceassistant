...
public class App {
	public static void main(String[] st) {
		...
		config.setDictionaryPath("src\\main\\resources\\4987.dic");
		config.setLanguageModelPath("src\\main\\resources\\4987.lm");
		...
		try {
			...
			while ((speechResult = speech.getResult()) != null) {
				...
				} else if (voiceCommand.equalsIgnoreCase("Close Google")) {
